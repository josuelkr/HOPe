...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      include 'par.for'
      character*30 nome
      integer i, j, k, t, my_rank, shift, var, n
      real*8  x, y, z,
     ...
     &         dthdy(imax,jmax,kfour)
      ...
      write(4,*) 'VARIABLES=,"x","duxmdy","laminar","turbulent"'
      ...
      do i = 1, imax
        ...
        write(4,5) x, average_t_duxmdy(i)*2d0/Re, lam, turb  
      end do
      close(4)
      ...
      do i = 1, imax
        ...
        write(4,5) x, average_t_dthmdy(i)/Re/Pr, lam, turb 
      end do
      close(4)
      ...
      do i = 1, imax
        x = x0 + dble(i-1) * dx
        write(4,2) x, - dtanh (3.0 * (x - 9.18045d0))   
c       write(4,2) x, 0.5d0 * (1- dtanh(3.0d0*(xa-9.18045d0)))  
      end do
      close(4)
