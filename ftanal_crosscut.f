...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &       mode00(imax/4+1,jmax),  Amp_max_00(imax/4+1),
     &       alpha_x(imax/4+1,N), alpha_xd2(imax/4+1,N), 
     &       Amp_max(imax/4+1,N), log_Amp_max(imax/4+1,N),
     &       Amp_maxd2(imax/4+1,N), log_Amp_maxd2(imax/4+1,N),
     &       Amp(imax/4+1,jmax,kphys,N), phase(imax/4+1,jmax,kphys,N),
     &       Ampd2(imax/4+1,jmax,kphys,N),
     &       phased2(imax/4+1,jmax,kphys,N),
     &       ux_p(imax/4+1,jmax,kphys,N), d2ux_p(imax/4+1,jmax,kphys,N),
     ...
     &"U_maxd2","alpha_xd2"'
      write(1,*) 'ZONE T="mode(0,0)", I=',imax/4
      do i = 2, imax/4 + 1
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      real*8        ux_p(imax/4+1,jmax,kphys,N),
     &            d2ux_p(imax/4+1,jmax,kphys,N),
     &            mode00(imax/4+1,jmax)
      complex*16 u_tanal(ptsx/4+1,jmax,kfour),
     &         u_tanalp1(ptsx/4+1,jmax,kfour),
     &         u_tanalp2(ptsx/4+1,jmax,kfour),
     &              ux_f(imax/4+1,jmax,kfour,N),
     &            d2ux_f(imax/4+1,jmax,kfour,N)
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      include 'par.for'
      integer i, f, N
      real*8 fc(imax/4+1,N), ddx(imax/4+1,N)
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &       wi, wpi, wpr, wr, wtemp, datap(imax/4+1,jmax,kphys,N)
      complex*16 dataf(imax/4+1,jmax,kfour,N)
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      real*8 tempi, tempr, dataff(imax/4+1,jmax,kphys,N),
